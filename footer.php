    ...
    <div class="row">
        <div class="mt-3 col-6 col-md-3 mb-3">
            ...
            <ul class="nav flex-column ">
                ...
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">UNIFY</a></li>
            </ul>
        </div>
        ...
        <div class="mt-3 col-6 col-md-3 mb-3">
            <h5>Account</h5>
            <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Sign Up</a></li>
                ...
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Track Your Order</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Book Fetch</a></li>
            </ul>
        </div>
        <div class="col-md-5 col-12 mb-3">
            ...
            <button class="btn reg_footer">    
                <label class="" for="">  REGISTER WITH US </label>
